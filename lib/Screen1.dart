              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Center(child: Text('Swift\nCafé', style: TextStyle(fontSize: 45, color: Colors.white, fontWeight: FontWeight.w300),)),
                  ),
                  SizedBox(height: height * 0.05,),
                  Container(
                    child: Text("${'"'}Latte but never late${'"'}",style: TextStyle(color: Color(0xffABABAB),fontSize: 14,fontWeight: FontWeight.bold,shadows: [
                      Shadow(
                      blurRadius: 25.0,
